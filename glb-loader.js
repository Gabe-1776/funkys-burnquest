/* three r0.160 GLTFLoader, converted from ESM to a plain script bound to the existing global THREE (window.THREE from self-hosted three.min.js). Sources: three@0.160.0 examples/jsm/loaders/GLTFLoader.js + utils/BufferGeometryUtils.js (toTrianglesDrawMode inlined). MIT license, copyright (c) 2010-2024 three.js authors */
(function(){
...
class GLTFParser {
	...
	constructor( json = {}, options = {} ) {
		...
		// Burnquest 2026-09-14: ALWAYS use TextureLoader.
		// ImageBitmapLoader is the Chrome/desktop path and was leaving Meshy
		// GLB baseColor maps unset (flat beige cars/frog/logs) on desktop
		// Chrome (Mac + Linux) while Safari and mobile Chrome looked fine —
		// same MacBook GPU, so not a VRAM story. Three already forces
		// TextureLoader on Safari for related reasons; extend that here.
